                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="<?php echo e(route('admin.manufacturer.add')); ?>" class="btn btn-success float-end">Add New</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><img width="150" src="<?php echo e(asset('assets/imgs/manufactor')); ?>/<?php echo e($category->logo); ?>"></td>
                                            <td><?php echo e($category->name); ?></td>
                                            <td><?php echo e($category->slug); ?></td>
                                            <td>
                                                <a href="<?php echo e(route('admin.manufacturer.edit',['manufacturer_id'=>$category->id])); ?>">Edit</a>
...
<?php /**PATH /home/buildbot/Desktop/kursova/resources/views/livewire/admin/admin-manufacturer-component.blade.php ENDPATH**/ ?>