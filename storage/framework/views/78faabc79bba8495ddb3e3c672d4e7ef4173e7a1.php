                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="<?php echo e(route('admin.products')); ?>" class="btn btn-succes float-end">All products</a>
                                </div>
                            </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <select class="form-control" name="device_id" wire:model="device_id">
                                        ...
                                        <?php $__currentLoopData = $devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($device->id); ?>"><?php echo e($device->manufactor->name); ?> <?php echo e($device->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <button type="submit" class="btn btn-primary float-end">Add New Product</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/buildbot/Desktop/kursova/resources/views/livewire/admin/admin-add-products-component.blade.php ENDPATH**/ ?>