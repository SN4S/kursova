                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <a href="<?php echo e(route('admin.categories')); ?>" class="btn btn-succes float-end">All categories</a>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('assets/imgs/categories')); ?>/<?php echo e($image); ?>" width="120">
                                    <?php endif; ?>
...
<?php /**PATH /home/buildbot/Desktop/kursova/resources/views/livewire/admin/admin-edit-categories-component.blade.php ENDPATH**/ ?>