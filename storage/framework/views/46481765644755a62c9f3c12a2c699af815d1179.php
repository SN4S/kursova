                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="<?php echo e(route('admin.device-type.add')); ?>" class="btn btn-success float-end">Add New Device type</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><img width="150" src="<?php echo e(asset('assets/imgs/device_type')); ?>/<?php echo e($category->image); ?>"></td>
                                            <td><?php echo e($category->name); ?></td>
                                            <td><?php echo e($category->description); ?></td>
                                            <td>
                                                <a href="<?php echo e(route('admin.device-type.edit',['dev_type_id'=>$category->id])); ?>">Edit</a>
...
<?php /**PATH /home/buildbot/Desktop/kursova/resources/views/livewire/admin/admin-device-type-component.blade.php ENDPATH**/ ?>