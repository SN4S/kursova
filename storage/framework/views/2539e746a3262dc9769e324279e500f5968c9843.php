<div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="<?php echo e(route('admin.products.add')); ?>" class="btn btn-success float-end">Add New Product</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><img src="<?php echo e(asset('assets/imgs/products')); ?>/<?php echo e($product->image); ?>" width="60px"></td>
                                            ...
                                            <td><?php echo e($product->device->manufactor->name); ?> <?php echo e($product->device->name); ?></td>
                                            <td>
                                                <a href="<?php echo e(route('admin.products.edit',['product_id'=>$product->id])); ?>">Edit</a>
                                                <a href="#" class="text-danger" data-toggle="modal" data-target="#exampleModal" onclick="deleteConfirmation(<?php echo e($product->id); ?>)">Delete</a>
                                            </td>
                                        </tr>
    ...
    <script>
        ...
        function deleteProduct(){
            window.livewire.find('<?php echo e($_instance->id); ?>').call('deleteProduct')
...
<?php /**PATH /home/buildbot/Desktop/kursova/resources/views/livewire/admin/admin-products-component.blade.php ENDPATH**/ ?>