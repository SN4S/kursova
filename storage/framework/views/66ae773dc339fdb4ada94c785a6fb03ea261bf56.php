                ...
                <div class="row">
                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="<?php echo e($orderBy == 'Date: New to Old' ? 'active' : ''); ?>" href="#" wire:click.prevent="changeOrderBy('Date: New to Old')">Date: New to Old</a></li>
                                            <li><a class="<?php echo e($orderBy == 'Date: Old to New' ? 'active' : ''); ?>" href="#" wire:click.prevent="changeOrderBy('Date: Old to New')">Date: Old to New</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="<?php echo e(route('product.details',['slug'=>$product->slug])); ?>">
                                                <img class="default-img" src="<?php echo e(asset('assets/imgs/products')); ?>/<?php echo e($product->image); ?>" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="<?php echo e(route('product.category',['slug'=>$product->category->slug])); ?>"><?php echo e($product->category->name); ?></a>
                                        </div>
                                        <h2><a href="<?php echo e(route('product.details',['slug'=>$product->slug])); ?>"><?php echo e($product->name); ?></a></h2>

                                        <div class="product-price">
                                            <span><?php echo e($product->price); ?></span>
                                        </div>
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store(<?php echo e($product->id); ?>,'<?php echo e($product->name); ?>',<?php echo e($product->price); ?>)"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <?php $__currentLoopData = $new_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new_p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>


                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="<?php echo e(asset('assets/imgs/products')); ?>/<?php echo e($new_p->image); ?>" alt="#">
                                </div>
                                <div class="content pt-10">
                                    <h5><a href="<?php echo e(route('product.details',['slug'=>$new_p->slug])); ?>"><?php echo e($new_p->name); ?></a></h5>
                                    <p class="price mb-0 mt-5">$<?php echo e($new_p->price); ?></p>
...
<?php
 ...
 ?><?php /**PATH /home/buildbot/Desktop/kursova/resources/views/livewire/shop-component.blade.php ENDPATH**/ ?>