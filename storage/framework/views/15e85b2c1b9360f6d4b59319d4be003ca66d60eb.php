                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="<?php echo e(route('admin.devices')); ?>" class="btn btn-succes float-end">All devices</a>
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <select class="form-control" name="device_type_id" wire:model="device_type_id">
                                            ...
                                            <?php $__currentLoopData = $dev_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($d->id); ?>"><?php echo e($d->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php $__errorArgs = ['device_type_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <select class="form-control" name="manufactor_id" wire:model="manufactor_id">
                                            ...
                                            <?php $__currentLoopData = $manufactor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($m->id); ?>"><?php echo e($m->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                        <?php $__errorArgs = ['manufactor_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <?php else: ?>
                                            <img src="<?php echo e(asset('assets/imgs/devices')); ?>/<?php echo e($image); ?>" width="120">
                                        <?php endif; ?>
...
<?php /**PATH /home/buildbot/Desktop/kursova/resources/views/livewire/admin/admin-edit-devices-component.blade.php ENDPATH**/ ?>